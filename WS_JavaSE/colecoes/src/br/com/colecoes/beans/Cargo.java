...
// Interface Comparable é nativa do Java e vamos usar para ordenação dos dados
	...
	// Comparação por Nome (ordem alfabetica)
	public int compareTo(Cargo outro) {
		return this.nome.compareTo(outro.nome);
	}
	
	/* Comparação por Nome (ordem ao contrário da alfabetica)
	public int compareTo(Cargo outro) {
