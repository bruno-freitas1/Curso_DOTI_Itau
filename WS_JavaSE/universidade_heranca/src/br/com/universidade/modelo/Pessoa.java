...
// abstract é usado para não permitir que seja instanciado individualmente na implementação
/*
 * tipos de modificadores para atributos:
 * private: mais alto grau de encapsulamento
 * public: mais baico grau de encapsulamento
 * package: libera acesso para classes que estiverem no mesmo diretório ou package
